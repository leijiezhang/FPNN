...
from models.model_run import fpn_run_reg_mlp
import torch
import os
...
param_config.config_parse('energy_config')
...
for i in torch.arange(len(param_config.dataset_list)):
    ...
    for kfold_idx in torch.arange(param_config.n_kfolds):
        ...
        fpn_train_acc, fpn_valid_acc = \
            fpn_run_reg_mlp(param_config, train_data, test_data, kfold_idx)
    ...
    data_save_file = f"{data_save_dir}/acc_fpn_{param_config.dataset_folder}" \
